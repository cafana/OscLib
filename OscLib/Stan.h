...
// of two by only including a subset.
...
// A lot of functions, many of which we don't need
//#include "stan/math/rev/fun.hpp"

// Let's include all the operators
...
// This is the full list of functions, and a guess at winnowing the list down
