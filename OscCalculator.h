...
namespace osc
{
  ...
  public:
    ...
    void SetDmsq21(const double& dmsq21) override { fDmsq21 = dmsq21; fUpdated = false; }
    void SetDmsq32(const double& dmsq32) override { fDmsq32 = dmsq32; fUpdated = false; }
    void SetTh12  (const double& th12  ) override { fTh12   = th12;   fUpdated = false; }
    void SetTh13  (const double& th13  ) override { fTh13   = th13;   fUpdated = false; }
    void SetTh23  (const double& th23  ) override { fTh23   = th23;   fUpdated = false; }
    void SetdCP   (const double& dCP   ) override { fdCP    = dCP;    fUpdated = false; }
